...
$this->load->model('tool/image');
			...
			$data['text_greeting'] = sprintf($language->get('text_new_greeting'), $order_info['payment_firstname']. ' ' . $order_info['payment_lastname'], html_entity_decode($order_info['store_name']));
