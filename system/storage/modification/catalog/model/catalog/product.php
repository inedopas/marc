...
class ModelCatalogProduct extends Model {
	...
	$product_data = array();
	$query = $this->db->query("SELECT `related_category` FROM `" . DB_PREFIX . "product` WHERE `product_id` = '" . (int)$product_id . "'");
