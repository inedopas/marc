...
$('#button-quote').on('click', function() {
    $.ajax({
          ...
          type: 'post',
          data: $('#product input[type=\'text\'], #product input[type=\'hidden\'], #product input[type=\'radio\']:checked, #product input[type=\'checkbox\']:checked,#buton, #product select, #product textarea'),
          dataType: 'json',
          beforeSend: function() {
