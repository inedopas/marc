...
class ControllerStartupSeoPro extends Controller {
	...
	public function index() {
        		...
        		if (isset($this->request->get['tracking']) && !empty($this->request->get['tracking'])) {
        			$this->session->data['partner_price'] = true;
        		}
	...
	public function rewrite($link) {
		...
		switch ($route) {
			case 'product/product':
				if ((isset($data['product_id'])) && $route != 'product/quickview') {
					$tmp = $data;
					$data = array();
