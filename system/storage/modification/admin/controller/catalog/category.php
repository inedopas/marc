...
class ControllerCatalogCategory extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
        ...
        if (isset($this->request->post['product_in_row'])) {
            $data['product_in_row'] = $this->request->post['product_in_row'];
        } elseif (!empty($category_info)) {
            $data['product_in_row'] = $category_info['product_in_row'];
        } else {
            $data['product_in_row'] = '';
        }
        ...
        if (isset($this->request->post['product_image_width'])) {
            ...
            $data['product_image_width'] = $category_info['product_image_width'];
        } else {
        ...
        if (isset($this->request->post['product_image_height'])) {
            ...
            $data['product_image_height'] = $category_info['product_image_height'];
        } else {
