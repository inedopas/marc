			...
			if (isset($product_option['product_option_value'])) {
				foreach ($product_option['product_option_value'] as $product_option_value) {
					$product_option_value_data[] = array(
						...
						'date_start'              => ($product_option_value['date_start'] != '0000-00-00') ? $product_option_value['date_start'] : '',
						'date_end'                => ($product_option_value['date_end'] != '0000-00-00') ? $product_option_value['date_end'] : '',
