            ...
            <div class="tab-pane" id="tab-option">
              <div class="row">
                ...
                <?php } ?>
                                ...
                                <input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][special]" value="<?php echo $product_option_value['special']; ?>" placeholder="<?php echo $entry_special; ?>" class="form-control" />
                                <div class="input-group date"><input data-date-format="YYYY-MM-DD" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][date_start]" value="<?php echo $product_option_value['date_start']; ?>" placeholder="<?php echo $entry_date_start; ?>" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div>
                                <div class="input-group date"><input data-date-format="YYYY-MM-DD" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][date_end]" value="<?php echo $product_option_value['date_end']; ?>" placeholder="<?php echo $entry_date_end; ?>" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>
...
function addOptionValue(option_row) {
	...
	html += '    <option value="-">-</option>';
	html += '  </select>';
	html += '  <input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][price]" value="" placeholder="<?php echo $entry_price; ?>" class="form-control" /><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][special]" value="" placeholder="<?php echo $entry_special; ?>" class="form-control" /><div class="input-group date"><input data-date-format="YYYY-MM-DD" type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][date_start]" value="" placeholder="<?php echo $entry_date_start; ?>" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div><div class="input-group date"><input data-date-format="YYYY-MM-DD" type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][date_end]" value="" placeholder="<?php echo $entry_date_end; ?>" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>';
