          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
				...
				<fieldset>
                <legend><?php echo $text_structured_data; ?></legend>
				<p><?php echo $text_structured_data_info; ?></p>
				<div class="form-group">
                  <label class="col-sm-2 control-label" for="input-support"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_support; ?>"><?php echo $entry_support; ?></span></label>
                  <div class="col-sm-10">
				...
				<div class="form-group">
                  <label class="col-sm-2 control-label" for="input-social"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_social; ?>"><?php echo $entry_social; ?></span></label>
                  <div class="col-sm-10">
                    <textarea name="config_social" rows="5" placeholder="<?php echo $entry_social; ?>" id="input-social" class="form-control"><?php echo $config_social; ?></textarea>
                   </div>
                </div>
				</fieldset>
