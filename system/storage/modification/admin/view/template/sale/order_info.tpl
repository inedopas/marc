      ...
      <div class="col-md-4">
        <div class="panel panel-default">
          ...
          <table class="table">
            ...
            <?php if ($comment) { ?>
        <table class="table table-bordered" style="color: red;font-size: 18px;">
          <thead>
            <tr>
      ...
      <div class="panel-body">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
	        ...
	        <td class="text-center"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" style="padding: 1px; border: 1px solid #DDDDDD;" title="<?php echo $product['name']; ?>"  /></td>
