$(document).ready(function() {
	setTimeout(function() {
	 	$('.options .form-group.required.option:first-of-type .radio.radio-type-button2:first-of-type span').trigger('click').trigger('change');
	 	$('.options .form-group.required.option:last-of-type .radio.radio-type-button2:visible:first span').trigger('click').trigger('change');
	 	$('.price').show();
	 }, 200);
     // Wrap selects
