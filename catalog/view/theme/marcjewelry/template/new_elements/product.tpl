...
<div class="product clearfix product-hover">
		...
		<?php if ($product['thumb'] || $product['custom_thumb']) { ?>
			...
			<div class="image <?php if($theme_options->get( 'product_image_effect' ) == '1') { echo 'image-swap-effect'; } ?>">
				<a href="<?php echo $product['href']; ?>">
					...
					<img src="image/catalog/blank.gif" data-echo="<?php echo ($product['custom_thumb'] ? $product['custom_thumb'] : $product['thumb']); ?>" alt="<?php echo $product['name']; ?>" class="<?php if($theme_options->get( 'product_image_effect' ) == '2') { echo 'zoom-image-effect'; } ?>" />
					<?php } else { ?>
					<img src="<?php echo ($product['custom_thumb'] ? $product['custom_thumb'] : $product['thumb']); ?>" alt="<?php echo $product['name']; ?>" class="<?php if($theme_options->get( 'product_image_effect' ) == '2') { echo 'zoom-image-effect'; } ?>" />
					<?php } ?>
				</a>
			</div>
		<?php } else { ?>
	...
	<div class="right">
        ...
        <div class="color_list">
            <div class="color_heading">Комплект <i class="fa fa-chevron-circle-down"></i></div>
      ...
      <!---Комплекты конец--->
		...
		<div class="price">
			<?php if ($product['newprice'] > 0 && $theme_options->get( 'display_text_sale' ) != '0') { ?>
			<?php echo "от <span class=\"price-old\">" . $product['price'] . " ₽</span>"; ?> <span class="price-new"><?php echo $product['newprice'] . " ₽"; ?></span>
			<?php } else { ?>
