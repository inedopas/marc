                             	...
                             	<div id="myCarousel<?php echo $id; ?>">
                             		...
                             		<div class="carousel-inner">
                             			<?php $i = 0; $row_fluid = 0; $item = 0; foreach ($product_tab['products'] as $product) { $row_fluid++; ?>
                         	    			...
                         	    			<div class="col-sm-<?php echo $class; ?> <?php if($class != 12) { ?>col-xs-12<?php } ?> <?php if($class == 2) { echo 'col-md-25 col-lg-2 col-sm-3 '; } if($class == 2 && $r == 0) { echo 'hidden-md hidden-sm'; } if($class == 2 && $r == 5) { echo 'hidden-sm'; } ?> <?php if($class == 25) { echo 'col-md-25 col-lg-25 col-sm-3 '; } if($class == 25 && $r == 0) { echo 'hidden-sm'; } ?>">
