     ...
     <?php 
        ...
        <form action="" method="post" enctype="multipart/form-data" id="contact" class="form-contact">
             ...
             <fieldset>
               ...
               <div class="contact-label">
                 <label for="input-email" class="required"> <?php echo "Номер телефона для связи" ?></label>
                 <div>
                   <input type="text" name="email" value="" id="input-email" class="form-control" />
                 </div>
               </div>
               <div class="contact-label">
                 <label for="input-enquiry"> <?php echo "Комментарии (необязательно)" ?></label>
                 <div>
