        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-product-in-row"><span data-toggle="tooltip" title="Количество товаров в одной строке">Количество товаров в одной строке</span></label>
                <div class="col-sm-10">
                  <input type="number" name="product_in_row" value="<?php echo $product_in_row; ?>" placeholder="Количество" id="input-product-in-row" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-product-image-width"><span data-toggle="tooltip" title="Ширина картинки для товара">Ширина картинки для товара</span></label>
                <div class="col-sm-10">
                  <input type="number" name="product_image_width" value="<?php echo $product_image_width; ?>" placeholder="Ширина" id="input-product-image-width" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-product-image-height"><span data-toggle="tooltip" title="Высота картинки для товара">Высота картинки для товара</span></label>
                <div class="col-sm-10">
                  <input type="number" name="product_image_height" value="<?php echo $product_image_height; ?>" placeholder="Высота" id="input-product-image-height" class="form-control" />
                </div>
              </div>
              <div class="form-group">
