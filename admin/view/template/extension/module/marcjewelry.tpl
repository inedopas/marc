...
<div id="content"><div class="container-fluid">
	<div class="page-header">
	    <h1>WebJeweler Theme Options</h1>
	    <ul class="breadcrumb">
		     <?php foreach ($breadcrumbs as $breadcrumb) { ?>
		      <li><a href="<?php echo $breadcrumb['href']; ?>"><?php echo "WebJeweler"; ?></a></li>
		      <?php } ?>
	    </ul>
	  </div>
	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<div id="tb_store_select">
			...
			<?php foreach ($stores as $store): ?>
				<option value="<?php echo 'index.php?route=extension/module/marcjewelry&store_id=' . $store['store_id'] . '&token=' . $_GET['token']; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
			<?php endforeach; ?>
			</select>
		</div>
                                    ...
                                    <div class="input">
                                    	...
                                    	<div class="list-language">
                                    		...
                                    		<div class="language select">
                                    			...
                                    			<?php
                                    				if ($handle = opendir('../catalog/view/theme/marcjewelry/js/countdown/')) {
