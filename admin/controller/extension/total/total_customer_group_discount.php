...
class ControllerExtensionTotalTotalCustomerGroupDiscount extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
			...
			$this->response->redirect($this->url->link('extension/total/total_customer_group_discount', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/total/total_customer_group_discount', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' :: '
		);

		$data['action'] = $this->url->link('extension/total/total_customer_group_discount', 'token=' . $this->session->data['token'], 'SSL');

		$data['cancel'] = $this->url->link('extension/total/total_customer_group_discount', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/total/total_customer_group_discount.tpl', $data));
	}
