<?php
/*
Template Name: Marcjewelry
Version: 1.0
Author: Artur Sulkowski
Website: http://artursulkowski.pl
*/

class ControllerExtensionModuleMarcjewelry extends Controller {
	...
	public function index() {
		...
		$this->language->load('extension/module/marcjewelry');

		//Set the title from the language file $_['heading_title'] string
		$this->document->setTitle('Marcjewelry Theme Options');
		...
		$data['setting_skin'] = $this->model_setting_setting->getSetting('marcjewelry_skin', $data['store_id']);
		...
		// Aktywna skorka
		if(isset($data['setting_skin']['marcjewelry_skin'])) {
			$data['active_skin'] = $data['setting_skin']['marcjewelry_skin'];
		} else {
			$data['active_skin'] = 'default';
		}

		if(!file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin'].'')) {
			$data['active_skin'] = false;
		}

		// Tworzenie listy skorek
		if(file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/')) {
			$data['skins'] = array();
			$dir = opendir(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/');
			while(false !== ($file = readdir($dir))) {
				if(is_dir(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$file) && $file != '.' && $file != '..')  {
					$data['skins'][] = $file;
				}
			}
			sort($data['skins']);
		...
		if(isset($data['setting_skin']['marcjewelry_skin'])) {
			$data['active_skin_edit'] = $data['setting_skin']['marcjewelry_skin'];
		} else {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if(isset($_POST['button-active'])){
				$save_marcjewelry_skin = array(
					'marcjewelry_skin' => $this->request->post['skin']
				);
				$this->model_setting_setting->editSetting('marcjewelry_skin', $save_marcjewelry_skin, $this->request->post['store_id']);
				$this->session->data['success'] = $this->language->get('text_success');
				$this->response->redirect($this->url->link('extension/module/marcjewelry&submit=true&store_id=' . $data['store_id'] . '', 'token=' . $this->session->data['token'], true));
            }
		}
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if(isset($_POST['add-skin'])){
				if(is_writable(DIR_CATALOG . 'view/theme/marcjewelry/skins/') && (is_writable(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/') || !file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'))) {
					// Sprawdzanie czy istnieje folder store_
					if(file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/') && filetype(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/') == 'dir') {
					} else {
						mkdir(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/', 0777);
					}

					// Dodawanie pliku z ustawieniami
					if($this->request->post['add-skin-name'] != '') {
						if(!file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$this->request->post['add-skin-name'].'/')) {
							mkdir(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$this->request->post['add-skin-name'].'/', 0777);
							file_put_contents(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$this->request->post['add-skin-name'].'/settings.json', json_encode($config_data));
							mkdir(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$this->request->post['add-skin-name'].'/js/', 0777);
							file_put_contents(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$this->request->post['add-skin-name'].'/js/custom_code.js', ' ');
							mkdir(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$this->request->post['add-skin-name'].'/css/', 0777);
							file_put_contents(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$this->request->post['add-skin-name'].'/css/custom_code.css', ' ');
							$this->session->data['success'] = $this->language->get('text_success');
							$this->response->redirect($this->url->link('extension/module/marcjewelry&submit=true&store_id=' . $data['store_id'] . '', 'token=' . $this->session->data['token'], true));
						}
					}
				...
				$this->session->data['error_warning'] = 'You need to set CHMOD 777 for all folder and subfolder in catalog/view/theme/marcjewelry/skins!';
				$this->response->redirect($this->url->link('extension/module/marcjewelry&submit=true&store_id=' . $data['store_id'] . '', 'token=' . $this->session->data['token'], true));
		    }
		}
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if(isset($_POST['button-save'])){
				if(is_writable(DIR_CATALOG . 'view/theme/marcjewelry/skins') && is_writable(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store']) && is_writable(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'])) {
					// Sprawdzanie czy istnieje skorka
					if(file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/') && filetype(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/') == 'dir' && file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'')) {
						// Zapisywanie ustawien
						file_put_contents(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'/settings.json', json_encode($this->request->post));

						// Custom js
						file_put_contents(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'/js/custom_code.js', html_entity_decode($this->request->post['custom_code_js']));

						// Custom css
						file_put_contents(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'/css/custom_code.css', html_entity_decode($this->request->post['custom_code_css']));

						// Informacja o zapisaniu ustawien
						$this->session->data['success'] = $this->language->get('text_success');
						$this->response->redirect($this->url->link('extension/module/marcjewelry&submit=true&store_id=' . $data['store_id'] . '&skin_edit=' . $data['active_skin_edit'] . '', 'token=' . $this->session->data['token'], true));
					}
				}
			...
			if(isset($_POST['button-save-live-editor'])){
                ...
                if(file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'/settings.json')) {
                    $template_temp = json_decode(file_get_contents(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'/settings.json'), true);
                    $data_temp = array();
				...
				if(is_writable(DIR_CATALOG . 'view/theme/marcjewelry/skins') && is_writable(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store']) && is_writable(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'])) {
					...
					if(file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/') && filetype(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/') == 'dir' && file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'')) {
						...
						// Informacja o zapisaniu ustawien
						$this->session->data['success'] = $this->language->get('text_success');
						$this->response->redirect($this->url->link('extension/module/marcjewelry&submit=true&store_id=' . $data['store_id'] . '&skin_edit=' . $data['active_skin_edit'] . '', 'live_editor=true&store_id='.$data['store_id'].'&token=' . $this->session->data['token'], true));
					}
				}

				// Jezeli nie istnieje katalog skorki to pojawia sie komunikat o bledzie
				$this->session->data['error_warning'] = 'You need to set CHMOD 777 for all folder and subfolder in catalog/view/theme/marcjewelry/skins!';
				$this->response->redirect($this->url->link('extension/module/marcjewelry&submit=true&store_id=' . $data['store_id'] . '', 'live_editor=true&store_id='.$data['store_id'].'&token=' . $this->session->data['token'], true));
			}
		}
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if(isset($_POST['button-delete'])){
				if(is_writable(DIR_CATALOG . 'view/theme/marcjewelry/skins')) {
					// Sprawdzanie czy istnieje skorka
					if(file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/') && filetype(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/') == 'dir' && file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'')) {
						// Sprawdzanie czy skorka jest ustawiona jako aktywna
						if($data['active_skin_edit'] != $data['active_skin']) {
							removeDir(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'');
		...
		// Pobieranie ustawien szablonu
		if(file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'/settings.json')) {
			$template = json_decode(file_get_contents(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'/settings.json'), true);
			if(isset($template)) {
		...
		if(file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'/js/custom_code.js')) {
			$data['custom_code_js'] = file_get_contents(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'/js/custom_code.js');
		}

		// Pobieranie ustawien szablon --> custom code css
		if(file_exists(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'/css/custom_code.css')) {
			$data['custom_code_css'] = file_get_contents(DIR_CATALOG . 'view/theme/marcjewelry/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'/css/custom_code.css');
		}
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
		     ...
		     if(isset($_POST['install_advanced_grid'])){
		          ...
		          include '../data_sample/marcjewelry/' . $this->request->post['select_demo'] . '/advanced_grid.php';

		     	$this->session->data['success'] = $this->language->get('text_success');
		     	$this->response->redirect($this->url->link('extension/module/marcjewelry', 'token=' . $this->session->data['token'], true));
		     }
		     ...
		     if(isset($_POST['install_breadcrumb_background_image'])){
		          ...
		          include '../data_sample/marcjewelry/' . $this->request->post['select_demo'] . '/breadcrumb_background_image.php';
		     ...
		     if(isset($_POST['install_filter_product'])){
		          ...
		          include '../data_sample/marcjewelry/' . $this->request->post['select_demo'] . '/filter_product.php';
		     ...
		     if(isset($_POST['install_header_notice'])){
		          ...
		          include '../data_sample/marcjewelry/' . $this->request->post['select_demo'] . '/header_notice.php';
		     ...
		     if(isset($_POST['install_cookie_module'])){
		          ...
		          include '../data_sample/marcjewelry/' . $this->request->post['select_demo'] . '/cookie_module.php';
		     ...
		     if(isset($_POST['install_product_questions'])){
		          ...
		          include '../data_sample/marcjewelry/' . $this->request->post['select_demo'] . '/product_questions.php';
		     ...
		     if(isset($_POST['install_faq'])){
		          ...
		          include '../data_sample/marcjewelry/' . $this->request->post['select_demo'] . '/faq.php';
		     ...
		     if(isset($_POST['install_popup'])){
		          ...
		          include '../data_sample/marcjewelry/' . $this->request->post['select_demo'] . '/popup.php';
		     ...
		     if(isset($_POST['install_product_blocks'])){
		          ...
		          include '../data_sample/marcjewelry/' . $this->request->post['select_demo'] . '/product_blocks.php';
			...
			if(isset($_POST['install_custom_module'])){
			     ...
			     include '../data_sample/marcjewelry/' . $this->request->post['select_demo'] . '/custom_module.php';
			...
			if(isset($_POST['install_carousel_item'])){
			     ...
			     include '../data_sample/marcjewelry/' . $this->request->post['select_demo'] . '/carousel_item.php';
			...
			if(isset($_POST['install_camera_slider'])){
				...
				include '../data_sample/marcjewelry/' . $this->request->post['select_demo'] . '/camera_slider_query.php';
			...
			if(isset($_POST['install_blog_latest_posts'])){
			     ...
			     include '../data_sample/marcjewelry/' . $this->request->post['select_demo'] . '/blog_latest_posts.php';
			...
			if(isset($_POST['install_megamenu'])){
				...
				include '../data_sample/marcjewelry/' . $this->request->post['select_demo'] . '/megamenu_query.php';
		...
		$data['action'] = $this->url->link('extension/module/marcjewelry', 'token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Marcjewelry Theme Options',
			'href' => $this->url->link('extension/module/marcjewelry', 'token=' . $this->session->data['token'], true)
		);
        ...
        $data['live_editor_link'] = $this->url->link('extension/module/marcjewelry', 'live_editor=true&store_id='.$data['store_id'].'&token=' . $this->session->data['token'], true);
		$data['theme_options_link'] = $this->url->link('extension/module/marcjewelry', 'store_id='.$data['store_id'].'&token=' . $this->session->data['token'], true);
        ...
        if(!isset($this->request->get['live_editor'])){
            ...
            $this->response->setOutput($this->load->view('extension/module/marcjewelry', $data));
        }else{
            $data['header'] = $this->load->controller('common/header');
            $data['footer'] = $this->load->controller('common/footer');
            ...
            $this->response->setOutput($this->load->view('extension/module/marcjewelry_live_editor', $data));
        }
	...
	private function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/marcjewelry')) {
